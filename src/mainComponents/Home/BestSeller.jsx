                ...
                <div className='w-full flex items-center md:justify-between justify-center flex-wrap gap-5'>
                    {isLoading ? (
                        ...
                        comic.map((book, i) => (
                            ...
                            >
                            <a href='/item' className='w-full h-full'>

                                    <span className='w-full h-[60%] flex items-center justify-center bg-[#555] relative overflow-hidden'>
                                        <OptimizedImage src={book.imageUrl} alt='comic book' fill={true} priority={i < 2} className='object-cover' />
                                    </span>
