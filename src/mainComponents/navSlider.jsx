            ...
            {/* NAVIGATION LINKS */}
                <nav className='2sm:w-[60%] w-[80%] flex flex-col items-center justify-start gap-2 mt-3'>
                    <motion.button className='w-full h-fit py-1 hover:bg-[#555] relative rounded'
                        ...
                        exit='hidden'
                    ><a href='/' onClick={slideHandle}>Home</a></motion.button>
                    <motion.button className='w-full h-fit py-1 hover:bg-[#555] relative rounded'
                        variants={scaleBig}
                        initial='hidden'
                        animate='visible'
                        ...
                        exit='hidden'
                    ><a href='/product' onClick={slideHandle}>Product</a></motion.button>
                    <motion.button className='w-full h-fit py-1 hover:bg-[#555] relative rounded'
                        variants={scaleBig}
                        initial='hidden'
                        animate='visible'
                        ...
                        onClick={slideHandle}
                    ><a href='/cart' onClick={slideHandle}>Cart</a></motion.button>
                    <motion.button className='w-full h-fit py-1 hover:bg-[#555] relative rounded'
                        variants={scaleBig}
                        initial='hidden'
                        animate='visible'
            ...
            {/* SOCIAL LINKS */}
                <span className='2sm:w-[60%] w-[80%] absolute bottom-[20px] left-auto right-auto gap-3 flex flex-col items-center justify-center'>
                    <motion.button className='w-full h-fit py-1 hover:bg-[#555] relative rounded flex items-center justify-center gap-2'
                        ...
                        transition={{delay: 1.4, duration: 0.5}}
                        onClick={slideHandle}
                    ><a href='/contact' className='flex items-center justify-center gap-2'>Contact us <IoMdCall/> </a></motion.button>
                    <motion.button className='w-full h-fit py-1 hover:bg-[#555] relative rounded flex items-center justify-center gap-2'
                        variants={slideUp}
                        initial='hidden'
                        animate='visible'
                        transition={{delay: 1.5, duration: 0.5}}
                        onClick={slideHandle}
                    >{mail !== null ? <span className='flex items-center gap-[10px]'>Logged In <IoMdPerson/></span> : <a href='/signup' className='flex items-center gap-[10px]'>No User <IoIosPersonAdd/></a>}</motion.button>
                </span>
            {/* SOCIAL LINKS */}
            </motion.span>
        </motion.div>
