  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center ">
        ...
        {/* TEXTS DIV */}
            ...
            <motion.span className='2md:w-[45%] md:w-[70%] 2sm:w-[80%] sm:w-[90%] w-full 2md:h-[55vh] h-[40vh] bg-transparent flex items-center justify-center overflow-hidden relative'
                    variants={appear}
                    initial='hidden'
                    animate='visible'
                    transition={{delay: 1, duration: 0.5}}
            >
              <OptimizedImage src='https://i.pinimg.com/564x/44/d2/39/44d239ecde45a8780993510e1bb4866a.jpg' alt='comic book' fill={true} priority={true} className='object-cover' />
            </motion.span>
        </div>
    </section>
  )
