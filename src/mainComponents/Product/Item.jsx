        ...
        <section className="w-full min-h-screen flex items-center justify-center ">
            ...
            <div  className='2sm:w-[80%] w-[90%] min-h-[80vh] flex flex-col  items-start justify-start pt-[15vh] '>
                ...
                <div className='w-full my-[5vh] flex items-start justify-start md:gap-5 gap-3 2sm:px-5 px-3'>
                    <span className='lg:min-w-[190px] md:min-w-[150px] 2sm:min-w-[130px] sm:min-w-[110px] min-w-[90px] lg:h-[260px] md:h-[220px] 2sm:h-[190px] sm:h-[160px] h-[130px] bg-[#555] flex items-center justify-center overflow-hidden shadow-md shadow-white/10 relative'>
                        <OptimizedImage src='https://i.pinimg.com/236x/df/86/36/df86360d78c84f76079824120c377d37.jpg' alt='items' fill={true} className='object-cover'/>
                    </span>
                        ...
                        {isLoading ? (
                            Array(3).fill(0).map((_, i) => (
                                <div key={i} className="animate-pulse">
                                    <div className="lg:w-[160px] md:w-[140px] 2sm:w-[120px] w-[100px] lg:h-[220px] md:h-[200px] 2sm:h-[170px] h-[140px] bg-gray-300 rounded mb-3" />
                            ...
                            books.map((book, i) => (
                                <div key={i} className=''>
                                    <span className='lg:w-[160px] md:w-[140px] 2sm:w-[120px] w-[100px] lg:h-[220px] md:h-[200px] 2sm:h-[170px] h-[140px]  bg-[#555] flex items-center justify-center overflow-hidden shadow-md shadow-white/10 md:mb-3 mb-2 hover-image-filter duration-300 relative'>
                                        <OptimizedImage src={book.imageUrl} alt={book.name} fill={true} className='object-cover'/>
                                    </span>
