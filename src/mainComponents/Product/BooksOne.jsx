                ...
                {isLoading ? (
                    ...
                    comic.map((book, i) => (
                        <motion.span key={i} className='sm:w-[200px] w-[230px] sm:h-[300px] h-[330px] flex flex-col items-start justify-start bg-[--whiteColor] text-[--blackColor] p-2 cursor-pointer'
                            ...
                            custom={i}
                        >
                            <a href='/item' className='w-full h-[60%] flex items-center justify-center bg-[#555] overflow-hidden relative'>
                                <OptimizedImage src={book.imageUrl} alt='comic book' fill={true} className='object-fit' />
                            </a>
